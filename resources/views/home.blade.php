...
@section('content')
    ...
    <div class="row rejtett">
        <div class="col-6">
            ...
            <input class="form-control" type="text" id="ujvaros" name="ujvaros" max="30" maxlength="30" value="" placeholder="Város neve">
    ...
    <script>
        $( document ).ready(function() {
            ...
            $('#felvesz').click(function() {
                $.post( "/ment", { meid: $( "#megyek" ).val(), ujvaros: $('#ujvaros').val(),"_token": "{{ csrf_token() }}", }, function( data ) {
                    if(data == 1){
                        $( "#megyek" ).change();
                    } else {
                        $("#hiba").html(data);
            ...
            $('#szerkeszt').click(function() {
                ...
                $.post( "/szerkeszt", { meid: $( "#megyek" ).val(),regiNev: regiNev , ujNev: ujNev,"_token": "{{ csrf_token() }}", }, function( data ) {
            ...
            $('#torol').click(function() {
                ...
                $.post( "/torol", { meid: $( "#megyek" ).val(), torlendoNev: $('#varos-nev').val(),"_token": "{{ csrf_token() }}", }, function( data ) {
